...
num_tasks = 1000  # Increased from 100 to 1000
x_ticks = range(100, num_tasks + 1, 100)  # Step changed from 10 to 100
...
for i in range(num_tasks):
    ...
    if (i + 1) % 100 == 0 or i == num_tasks - 1:  # Condition changed from % 10 to % 100
